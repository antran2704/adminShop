        ...
        if (data.isReaded) {
            if (data.path) {
                if (data.type === NotitficationType.product) {
                    router.push(
                        `/edit/${data.path.replace("products", "product")}`
                    );
                } else {
            ...
            <div className="relative">
                <div
                    ...
                    className={`relative flex items-center justify-center p-2 ${
                        showModal
                            ? "bg-slate-200"
                            : "bg-slate-100 dark:bg-transparent hover:bg-slate-200 dark:hover:bg-slate-200"
                    } ${
                    ...
                    <FaRegBell
                        className={`${
                            ...
                            showModal ? "dark:text-black" : "dark:text-white dark:hover:text-black"
